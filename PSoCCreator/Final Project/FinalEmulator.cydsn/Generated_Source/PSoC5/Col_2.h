...
void    Col_2_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Col_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Col_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Col_2_SetInterruptMode() function.
     *  @{
     */
        #define Col_2_INTR_NONE      (uint16)(0x0000u)
        #define Col_2_INTR_RISING    (uint16)(0x0001u)
        #define Col_2_INTR_FALLING   (uint16)(0x0002u)
        #define Col_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Col_2_INTR_MASK      (0x01u) 
#endif /* (Col_2__INTSTAT) */
...
/* SIO registers */
#if defined(Col_2__SIO_CFG)
    #define Col_2_SIO_HYST_EN        (* (reg8 *) Col_2__SIO_HYST_EN)
    #define Col_2_SIO_REG_HIFREQ     (* (reg8 *) Col_2__SIO_REG_HIFREQ)
    #define Col_2_SIO_CFG            (* (reg8 *) Col_2__SIO_CFG)
    #define Col_2_SIO_DIFF           (* (reg8 *) Col_2__SIO_DIFF)
#endif /* (Col_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Col_2_0_INTTYPE_REG 		(* (reg8 *) Col_2__0__INTTYPE)
#endif /* (Col_2__INTSTAT) */
