...
#if !(CY_PSOC5A &&\
	 usb_uart_Dp__PORT == 15 && ((usb_uart_Dp__MASK & 0xC0) != 0))
...
void    usb_uart_Dp_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the usb_uart_Dp_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(usb_uart_Dp__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in usb_uart_Dp_SetInterruptMode() function.
     *  @{
     */
        #define usb_uart_Dp_INTR_NONE      (uint16)(0x0000u)
        #define usb_uart_Dp_INTR_RISING    (uint16)(0x0001u)
        #define usb_uart_Dp_INTR_FALLING   (uint16)(0x0002u)
        #define usb_uart_Dp_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define usb_uart_Dp_INTR_MASK      (0x01u) 
#endif /* (usb_uart_Dp__INTSTAT) */
...
/* SIO registers */
#if defined(usb_uart_Dp__SIO_CFG)
    #define usb_uart_Dp_SIO_HYST_EN        (* (reg8 *) usb_uart_Dp__SIO_HYST_EN)
    #define usb_uart_Dp_SIO_REG_HIFREQ     (* (reg8 *) usb_uart_Dp__SIO_REG_HIFREQ)
    #define usb_uart_Dp_SIO_CFG            (* (reg8 *) usb_uart_Dp__SIO_CFG)
    #define usb_uart_Dp_SIO_DIFF           (* (reg8 *) usb_uart_Dp__SIO_DIFF)
#endif /* (usb_uart_Dp__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define usb_uart_Dp_0_INTTYPE_REG 		(* (reg8 *) usb_uart_Dp__0__INTTYPE)
#endif /* (usb_uart_Dp__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_usb_uart_Dp_H */
