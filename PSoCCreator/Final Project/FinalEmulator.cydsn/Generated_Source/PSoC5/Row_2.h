...
*/
     ...
     *  @{
     */
        #define Row_2_INTR_NONE      (uint16)(0x0000u)
        #define Row_2_INTR_RISING    (uint16)(0x0001u)
        #define Row_2_INTR_FALLING   (uint16)(0x0002u)
        #define Row_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Row_2_INTR_MASK      (0x01u) 
#endif /* (Row_2__INTSTAT) */
...
/* SIO registers */
#if defined(Row_2__SIO_CFG)
    #define Row_2_SIO_HYST_EN        (* (reg8 *) Row_2__SIO_HYST_EN)
    #define Row_2_SIO_REG_HIFREQ     (* (reg8 *) Row_2__SIO_REG_HIFREQ)
    #define Row_2_SIO_CFG            (* (reg8 *) Row_2__SIO_CFG)
    #define Row_2_SIO_DIFF           (* (reg8 *) Row_2__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Row_2_0_INTTYPE_REG 		(* (reg8 *) Row_2__0__INTTYPE)
#endif /* (Row_2__INTSTAT) */
