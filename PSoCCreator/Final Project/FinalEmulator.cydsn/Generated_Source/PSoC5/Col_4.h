...
#if !(CY_PSOC5A &&\
	 Col_4__PORT == 15 && ((Col_4__MASK & 0xC0) != 0))
...
void    Col_4_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Col_4_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Col_4__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Col_4_SetInterruptMode() function.
     *  @{
     */
        #define Col_4_INTR_NONE      (uint16)(0x0000u)
        #define Col_4_INTR_RISING    (uint16)(0x0001u)
        #define Col_4_INTR_FALLING   (uint16)(0x0002u)
        #define Col_4_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Col_4_INTR_MASK      (0x01u) 
#endif /* (Col_4__INTSTAT) */
...
/* SIO registers */
#if defined(Col_4__SIO_CFG)
    #define Col_4_SIO_HYST_EN        (* (reg8 *) Col_4__SIO_HYST_EN)
    #define Col_4_SIO_REG_HIFREQ     (* (reg8 *) Col_4__SIO_REG_HIFREQ)
    #define Col_4_SIO_CFG            (* (reg8 *) Col_4__SIO_CFG)
    #define Col_4_SIO_DIFF           (* (reg8 *) Col_4__SIO_DIFF)
#endif /* (Col_4__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Col_4_0_INTTYPE_REG 		(* (reg8 *) Col_4__0__INTTYPE)
#endif /* (Col_4__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Col_4_H */
