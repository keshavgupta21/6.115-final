...
# Date: Thu, 02 May 2019 15:41:44 GMT
#set_units -time ns
create_clock -name {clk_timer(routed)} -period 166664.47368421051 -waveform {0 83332.2368421053} [list [get_pins {ClockBlock/dclk_1}]]
...
create_generated_clock -name {clk_timer} -source [get_pins {ClockBlock/clk_sync}] -edges {1 10857 21715} [list [get_pins {ClockBlock/dclk_glb_1}]]
