...
*
* \funcusage
*  \snippet usb_uart_Dm_SUT.c usage_usb_uart_Dm_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet usb_uart_Dm_SUT.c usage_usb_uart_Dm_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet usb_uart_Dm_SUT.c usage_usb_uart_Dm_Read  
*******************************************************************************/
...
* preferred usb_uart_Dm_Read() API because the 
* usb_uart_Dm_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet usb_uart_Dm_SUT.c usage_usb_uart_Dm_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: usb_uart_Dm_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use usb_uart_Dm_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - usb_uart_Dm_0_INTR       (First pin in the list)
    *  - usb_uart_Dm_1_INTR       (Second pin in the list)
    *  - ...
    *  - usb_uart_Dm_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet usb_uart_Dm_SUT.c usage_usb_uart_Dm_SetInterruptMode
    *******************************************************************************/
    void usb_uart_Dm_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & usb_uart_Dm_0_INTR) != 0u) 
		{ 
			 usb_uart_Dm_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet usb_uart_Dm_SUT.c usage_usb_uart_Dm_ClearInterrupt
    *******************************************************************************/
