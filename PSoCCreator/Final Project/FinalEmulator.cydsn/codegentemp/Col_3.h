...
#if !(CY_PSOC5A &&\
	 Col_3__PORT == 15 && ((Col_3__MASK & 0xC0) != 0))
...
void    Col_3_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Col_3_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Col_3__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Col_3_SetInterruptMode() function.
     *  @{
     */
        #define Col_3_INTR_NONE      (uint16)(0x0000u)
        #define Col_3_INTR_RISING    (uint16)(0x0001u)
        #define Col_3_INTR_FALLING   (uint16)(0x0002u)
        #define Col_3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Col_3_INTR_MASK      (0x01u) 
#endif /* (Col_3__INTSTAT) */
...
/* SIO registers */
#if defined(Col_3__SIO_CFG)
    #define Col_3_SIO_HYST_EN        (* (reg8 *) Col_3__SIO_HYST_EN)
    #define Col_3_SIO_REG_HIFREQ     (* (reg8 *) Col_3__SIO_REG_HIFREQ)
    #define Col_3_SIO_CFG            (* (reg8 *) Col_3__SIO_CFG)
    #define Col_3_SIO_DIFF           (* (reg8 *) Col_3__SIO_DIFF)
#endif /* (Col_3__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Col_3_0_INTTYPE_REG 		(* (reg8 *) Col_3__0__INTTYPE)
#endif /* (Col_3__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Col_3_H */
